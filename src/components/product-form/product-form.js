...
const ProductForm = (props) => {
  ...
  return (
    <div className={`${props.className} product-form`}>
      <div className={`${classes.join(' ')} product-form__block-wrapper`}
      ...
      <div className="product-form__below-text">
        {props.product.disabled === false ? (
          props.product.selected === true ? props.product.description :
            <BelowText onClick={() => props.OnClick(props.product.id)}/>
